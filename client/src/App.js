...
function App() {
  ...
  const fetchTodoList = () => {
    axios.get("https://todolist-9xvq.onrender.com/get-todo")
  ...
  const addUpdateTodo = () => {
    if (isUpdating === "") {
      axios.post("https://todolist-9xvq.onrender.com/save-todo", { text })
        .then((res) => {
      ...
      axios.post("https://todolist-9xvq.onrender.com/update-todo", { _id: isUpdating, text })
        .then((res) => {
          console.log(res.data);
          setText("");
          setUpdating("");
  ...
  const deleteTodo = (_id) => {
    axios.post("https://todolist-9xvq.onrender.com/delete-todo", { _id })
      .then((res) => {
        console.log(res.data);
